...
to missing jQuery versions if files were moved outside the uikit_package.
...
.. code-block:: html
    ...
    EXT:uikit_package/Resources/Private/Less/
...
.. code-block:: html
    ...
    EXT:uikit_package/Resources/Public/Less/
...
.. code-block:: typoscript
    ...
    plugin.uikit_package {
        settings.less {
            icon-font-path = "../../../../../typo3conf/ext/uikit_package/Resources/Public/Fonts/"
        }
    }
...
.. code-block:: typoscript
    ...
    page.10 {
        ...
        file.stdWrap.cObject {
            ...
            uikit_package__default_clean = TEXT
            uikit_package__default_clean.value = {$page.fluidtemplate.templateRootPath}DefaultClean.html
            uikit_package__default_clean.insertData = 1
...
.. code-block:: typoscript
    ...
    page.10 {
        ...
        templateName.stdWrap.cObject {
            ...
            uikit_package__default_clean = TEXT
            uikit_package__default_clean.value = DefaultClean

            ...

        }
        templateRootPaths {
            0 = EXT:uikit_package/Resources/Private/Templates/Page/
            1 = {$page.fluidtemplate.templateRootPath}
        }
        partialRootPaths {
            0 = EXT:uikit_package/Resources/Private/Partials/Page/
            1 = {$page.fluidtemplate.partialRootPath}
        }
        layoutRootPaths {
            0 = EXT:uikit_package/Resources/Private/Layouts/Page/
...
.. code-block:: bash
    ...
    uikit_package__default_subnavigation
    uikit_package__default_subnavigation_2_columns

**Alternatives Templates**

.. code-block:: bash

    uikit_package__default_subnavigation_right
    uikit_package__default_subnavigation_right_2_columns
