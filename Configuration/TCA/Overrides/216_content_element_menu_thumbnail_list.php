...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'LLL:EXT:uikit_package/Resources/Private/Language/Backend.xlf:menu.thumbnail_list',
        'menu_thumbnail_list',
...
$GLOBALS['TCA']['tt_content']['types']['menu_thumbnail_list'] = array_replace_recursive(
    ...
    [
        'showitem' => '
            ...
            --div--;LLL:EXT:uikit_package/Resources/Private/Language/Backend.xlf:menu.thumbnail.options,
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
    '*',
    'FILE:EXT:uikit_package/Configuration/FlexForms/MenuThumbnail.xml',
    'menu_thumbnail_list'
);
